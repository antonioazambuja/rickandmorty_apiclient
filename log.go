...
var LogLocation  = log.New(os.Stderr, "Location API: ", log.Ldate|log.Lmicroseconds|log.Lshortfile)
// LogEpisode is used for logs in calls of Episode endpoint
var LogEpisode  = log.New(os.Stderr, "Episode API: ", log.Ldate|log.Lmicroseconds|log.Lshortfile)
